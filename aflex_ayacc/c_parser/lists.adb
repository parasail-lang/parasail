...
package body Lists is
    ...
    begin
        New_Element := new Element_Type'(Item => Element,
          Next => null);
        if L.Head = null then
    ...
    procedure Deletehead (L : in out List) is
        ...
        --| Remove the element of the head of the list and return it
        --| to the heap. If L is null EmptyList.
    ...
    procedure Deleteitem (L : in out List;
        ...
        --| Remove the first element in the list with the
        --| value Element.
    ...
    function Isinlist (L : in List;
        ...
        --| Check if Element is in L.  If it is return true
    ...
    procedure Replacehead (L : in out List;
        ...
        --| with the given information. If the list is empty the
        --| exception EmptyList is raised.
    ...
    function Equal (List1 : in List;
        ...
        --| If both PlaceInList1 and PlaceInList2 are null after exiting
        --| the loop
        --| then the lists are equal.  If they both are not null the
        --| lists aren't equal. Note that equality on elemenst is based
        --| on a user supplied
