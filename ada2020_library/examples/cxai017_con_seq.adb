...
procedure CXAI017_Con_Seq is
   ...
   Num_Random : constant := 50_000_000;
...
--       Element_Type => My_Float); -- Default =
   ...
   procedure My_Con_Ran_Array_Heapsort is new
   --  Ada_Constrained_Sort
     Ada.Containers.Generic_Constrained_Array_Sort
   ...
   procedure My_Con_Ran_Array_QSort is new
     Ada_Constrained_Sort
   --   Ada.Containers.Generic_Constrained_Array_Sort
     (Index_Type   => Con_Ran_Bounds_Type,
      Element_Type => Float,
...
begin
   Put_Line
     ("CXAI017_Con_Seq: " &
      "Check that an implementation supports the sequential version of " &
   ...
   for I in 1 .. 8 loop
      ...
      --  And sort it
      if I mod 2 = 1 then
         My_Con_Ran_Array_Heapsort
           (Container => To_Be_Sorted_Ran_Con_Array.all);
      else
         My_Con_Ran_Array_QSort
           (Container => To_Be_Sorted_Ran_Con_Array.all);
      end if;
      ...
      Put_Line (I'Image & ":" & Diff'Image & " seconds -- " &
        (if I mod 2 = 1 then "heapsort" else "qsort"));
