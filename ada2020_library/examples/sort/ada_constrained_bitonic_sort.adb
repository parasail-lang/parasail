...
procedure Ada_Constrained_Bitonic_Sort
  (Container : in out Array_Type)
is
   --  Instantiate parallel "work list" generic
   --  and use it for parallelizing the bitonic sort algorithm.
   ...
   --     Ascending_First xor Bit_Count_Odd (Zero-based-index / Pow_Dir)
      ...
      begin  --  parallel for-loop body
         for I in Uns range Uns'Val (Low) .. Uns'Val (High) loop
   ...
   begin  --  Bitonic_Sorting_Pass
      ...
      Par_Range_Loop
        (Low => 0, High => Uns'Pos (Len - 1),
         Num_Chunks => 10,  --  TBD: tuning
...
begin  --  Ada_Constrained_Bitonic_Sort
   ...
   pragma Warnings (On);
end Ada_Constrained_Bitonic_Sort;
