...
package Ada.Containers.Hashed_Maps is
   ...
   package Sequential_Map_Iterator_Interfaces is new
     Ada.Iterator_Interfaces (Cursor, Has_Element);
   package Map_Iterator_Interfaces is new
     System.Parallelism.Parallel_Iterator_Interfaces
       (Sequential_Map_Iterator_Interfaces);
...
private
   ...
   use Map_Iterator_Interfaces;

   type Iterator is new Limited_Controlled and
     Map_Iterator_Interfaces.Parallel_Iterator with
   record
      Container : Map_Access;
      Num_Chunks : Chunk_Index'Base := 0;  --  Zero means not yet split
   end record
   ...
   overriding function Is_Split (Object : Iterator) return Boolean;

   overriding procedure Split_Into_Chunks
     (Object     : in out Iterator;
      Max_Chunks : Chunk_Index);

   overriding function Chunk_Count (Object : Iterator) return Chunk_Index;

   overriding function First (Object : Iterator;
