...
package body Generic_Parallel_Work_Lists is
   ...
   procedure Par_Iterate_Work_List
     (Initial_Item : Work_Item; Num_Chunks : Positive;
      ...
      Group : aliased System.LWT.LWT_Group;
      --  All spawned threads will use this group

      type LWT_Data_Extension is new System.LWT.Root_Data with record
      ...
      procedure Reclaim_Storage (Extended_Data : access LWT_Data_Extension;
                                 Server_Index : System.LWT.LWT_Server_Index);
      ...
      begin
         ...
         then
            ...
            System.LWT.Spawn_LWT (Group, LWT_Data_Ptr'
              (new LWT_Data_Extension'
                 (System.LWT.Root_Data with New_Item)));
         end if;
      end Add_Work_Item;
      ...
      procedure Reclaim_Storage (Extended_Data : access LWT_Data_Extension;
                                 Server_Index : System.LWT.LWT_Server_Index) is
...
end Generic_Parallel_Work_Lists;
