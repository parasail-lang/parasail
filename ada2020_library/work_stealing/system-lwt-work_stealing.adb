...
pragma Elaborate_All (Generic_Synchronized_Deques);

with Generic_Atomic_Max_Min;
pragma Elaborate_All (Generic_Atomic_Max_Min);

with System.LWT;
pragma Elaborate (System.LWT);

with Ada.Dynamic_Priorities;

with System.Multiprocessors;
with System.LWT.Statistics; use System.LWT.Statistics;
--  with System.LWT.Storage;  --  TBD: not needed until GNAT bug fixed
with System.Storage_Elements;

package body System.LWT.Work_Stealing is
...
--       end if;
   ...
   procedure Spawn_LWT
     (Group : in out WS_Group;
      Data : access Root_Data'Class;
      Aspects : access Ada.Aspects.Root_Aspect'Class := null) is
   ...
   type WS_Plugin_Type is
     new System.LWT.LWT_Scheduler_Plugin with null record;
   ...
   --  before returning from LWT_Range_Loop.
      ...
      --  TBD:  with Storage_Pool => System.LWT.Storage.LWT_Storage_Pool_Obj;
   ...
   begin  --  Incr_WS_Parallel_Regions
      ...
      if Pre_Value = 0 then
         ...
         System.LWT.Install_Scheduler_Plugin (WS_Plugin'Access);
      end if;
   ...
   begin  --  Decr_WS_Parallel_Regions
      ...
      if Pre_Value = 1 then
         ...
         System.LWT.Remove_Scheduler_Plugin (WS_Plugin'Access);
