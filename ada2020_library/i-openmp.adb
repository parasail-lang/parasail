...
with System.LWT.OpenMP;

package body Interfaces.OpenMP is
   ...
   begin
      ...
      System.LWT.OpenMP.Set_Ada_Task_Identity (Data.Associated_Ada_Task);
      ...
      System.LWT.OpenMP.Set_Ada_Task_Identity (Null_Task_Id);
   ...
   begin
      ...
      System.LWT.OpenMP.Incr_OpenMP_Parallel_Regions;
      ...
      Obj.Data.Associated_Ada_Task := System.LWT.Ada_Task_Identity;
