...
package Parasail_Tokens is
    ...
    type Token is
        (End_Of_Input, Error, ',', ';',
         ...
         Leq, Lshift, Power,
         Assign, Swap, Move,
         Combine_Move, Dot_Dot, Angle_Dot_Dot_Angle,
         ...
         Power_Assign, Combine_Assign, And_Assign,
         Or_Assign, Xor_Assign, Lshift_Assign,
         Rshift_Assign, Newline, Outdent,
         Indent, Eol_Colon, Plus_Based_Op,
         Minus_Based_Op, Mul_Based_Op, Div_Based_Op,
         Exp_Based_Op, Or_Based_Op, And_Based_Op,
         Xor_Based_Op, Not_Based_Op, Lshift_Based_Op,
         Rshift_Based_Op, Combine_Based_Op, Char_Literal,
         Enum_Literal, Integer_Literal, Real_Literal,
         String_Literal, Identifier, Abs_Kw,
         Abstract_Kw, All_Kw, And_Kw,
         Begin_Kw, Block_Kw, Case_Kw,
         Class_Kw, Concurrent_Kw, Const_Kw,
         Continue_Kw, Each_Kw, Else_Kw,
