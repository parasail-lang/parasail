...
procedure N_Queens_Counted is
   ...
   Max_Remembered : constant := 50;  --  only remember first 50
   Max_Solutions : constant := 5000;  --  only find first 5000
   Atomic_Num_Solutions : Natural := 0 with Atomic;
   ...
   private
      Num_Sols : Natural := 0;
      Num_Saved : Natural := 0;
      Solutions : Sol_Array (1 .. Max_Remembered);
   end Prot;
      ...
      for I in 1 .. N loop
         if Can_Add (Partial_Solution, I) then
            ...
            begin
               ...
               exit when Atomic_Num_Solutions >= Max_Solutions;
            end;
         end if;
      end loop;
   end Try_Next_Queen;
