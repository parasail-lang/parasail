...
with PSC.Interpreter.Ada202x_Builtins;
...
use PSC;
procedure Call_Compiled_A2X_Main is
   use Interpreter;
   ...
   pragma Import (Ada, Test_Operation_Descriptor,
     Link_Name => Link_Names.Link_Name_Prefix &
       "A2X" & Link_Names.Dot & "Test" & Link_Names.Dot &
...
begin
   ...
   Languages.Set_Language (Languages.Ada202x);
   ...
   declare
      ...
      Op_Desc_Type : constant Type_Descriptor_Ptr :=
         ...
         Type_Descriptor_Ops.Get_Type_Desc_By_Name
            (String_Lookup (Languages.Operation_Descriptor_Type_Name));
   begin
