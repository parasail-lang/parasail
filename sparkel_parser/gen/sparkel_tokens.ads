...
package Sparkel_Tokens is
    ...
    type Token is
        (End_Of_Input, Error, ',', ';',
         ...
         Geq, Leq, Lshift,
         Power, Assign, Swap,
         Move, Combine_Move, Box,
         Dot_Dot, Open_Closed_Interval, Open_Interval,
         Closed_Open_Interval, Double_Colon, Refers_To,
         Gives, Implies, Parallel,
         Plus_Assign, Minus_Assign, Times_Assign,
         Divide_Assign, Power_Assign, Combine_Assign,
         Ampersand_Assign, And_Assign, Or_Assign,
         ...
         Access_Kw, Aliased_Kw, All_Kw,
         And_Kw, Array_Kw, Assert_Kw,
         Begin_Kw, Block_Kw, Body_Kw,
         Case_Kw, Class_Kw, Concurrent_Kw,
         Const_Kw, Constant_Kw, Continue_Kw,
         Declare_Kw, Delta_Kw, Digits_Kw,
         Each_Kw, Else_Kw, Elsif_Kw,
         End_Kw, Exception_Kw, Exit_Kw,
         Exports_Kw, Extends_Kw, For_Kw,
         Forward_Kw, Func_Kw, Generic_Kw,
         Global_Kw, If_Kw, Implements_Kw,
         Import_Kw, In_Kw, Interface_Kw,
         Is_Kw, Lambda_Kw, Limited_Kw,
         Locked_Kw, Loop_Kw, Mod_Kw,
         New_Kw, Not_Kw, Null_Kw,
         Of_Kw, Op_Kw, Optional_Kw,
         Or_Kw, Others_Kw, Out_Kw,
         Package_Kw, Parallel_Kw, Pragma_Kw,
         Private_Kw, Proc_Kw, Protected_Kw,
         Queued_Kw, Raise_Kw, Range_Kw,
         Record_Kw, Ref_Kw, Rem_Kw,
         Renames_Kw, Return_Kw, Reverse_Kw,
