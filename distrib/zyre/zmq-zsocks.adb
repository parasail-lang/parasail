...
package body ZMQ.Zsocks is
   ...
   --  CZMQ_EXPORT zsock_t *
   --  zsock_new (int type);
   function Zsock_New (Kind : Integer) return Zsock is
   begin
      return (Raw => zsock_h.zsock_new (Integer'Pos (Kind)));
   end;
   ...
   function Zsock_New_Pair (Endpoint : String) return Zsock is
      use Interfaces.C.Strings;
      c_endpoint : chars_ptr := New_String (Endpoint);
   begin
      return Result : constant Zsock :=
        (Raw => zsock_h.zsock_new_pair (c_endpoint)) do
         Free (c_endpoint);
      end return;
   end;
   ...
   procedure Zsock_Destroy (Self_P : in out Zsock) is
   begin
      zsock_h.zsock_destroy (Self_P.Raw'Address);
   end;
   ...
   function Zsock_Bind (Self : Zsock; Endpoint : String) return Integer is
      use Interfaces.C.Strings;
      c_endpoint : chars_ptr := New_String (Endpoint);
   begin
      return Result : constant Integer := Integer
        (zsock_h.zsock_bind (Self.Raw, c_endpoint)) do
         Free (c_endpoint);
      end return;
   end;
   ...
   function Zsock_Connect (Self : Zsock; Endpoint : String) return Integer is
      use Interfaces.C.Strings;
      c_endpoint : chars_ptr := New_String (Endpoint);
   begin
      return Result : constant Integer := Integer
        (zsock_h.zsock_connect (Self.Raw, c_endpoint)) do
         Free (c_endpoint);
      end return;
   end;
