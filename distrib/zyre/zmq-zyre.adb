...
package body ZMQ.Zyre is
   ...
   function Zyre_New (Name : String) return Zyre_Node is
      use Interfaces.C.Strings;
      c_name : chars_ptr := (if Name'Length = 0 then Null_Ptr
                             else New_String (Name));
   begin
      return Result : constant Zyre_Node :=
                        (Raw => zyre_h.zyre_new (c_name)) do
         if c_name /= Null_Ptr then
            Free (c_name);
         end if;
      end return;
   end;
   ...
   procedure Zyre_Destroy (Self : in out Zyre_Node) is
   begin
      zyre_h.zyre_destroy (Self.Raw'Address);
   end;
   
   --  Return our node UUID string, after successful initialization
   --  ZYRE_EXPORT const char *
   --      zyre_uuid (zyre_t *self);
   function Zyre_UUID (Self : Zyre_Node) return String is
      use Interfaces.C.Strings;
   begin
      return Value (zyre_h.zyre_uuid (Self.Raw));
   end;
   ...
   function Zyre_Name (Self : Zyre_Node) return String is
      use Interfaces.C.Strings;
   begin
      return Value (zyre_h.zyre_name (Self.Raw));
   end;
   ...
   procedure Set_Zyre_Name (Self : in out Zyre_Node; Name : String) is
   begin
      raise NYI;
   end;
   ...
   procedure Zyre_Set_Header (Self : in out Zyre_Node; Name : String;
      ...
      c_header : chars_ptr := New_String (Header);
   begin
      zyre_h.zyre_set_header (Self.Raw, c_name, c_header);
      Free (c_name);
      Free (c_header);
   end;
   ...
   procedure Zyre_Set_Verbose (Self : in out Zyre_Node) is
   begin
      zyre_h.zyre_set_verbose (Self.Raw);
   end;
   ...
   procedure Zyre_Set_Port (Self : in out Zyre_Node; Port_Nbr : Integer) is
   begin
      raise NYI;
   end;
   ...
   procedure Zyre_Set_Evasive_Timeout
     (Self : in out Zyre_Node; Interval : Integer) is
   begin
      raise NYI;
   end;
   ...
   procedure Zyre_Set_Interval
     (Self : in out Zyre_Node; Interval : Long_Integer) is
   begin
      raise NYI;
   end;
   ...
   procedure Zyre_Set_Interface
     (Self : in out Zyre_Node; Value : String) is
   begin
      raise NYI;
   end;
   ...
   procedure Zyre_Gossip_Bind
     (Self : in out Zyre_Node; Endpoint : String) is
   begin
      raise NYI;
   end;
   ...
   function Zyre_Start (Self : in out Zyre_Node) return Return_Status is
   begin
      return Return_Status (zyre_h.zyre_start (Self.Raw));
   end;
   ...
   procedure Zyre_Stop (Self : in out Zyre_Node) is
   begin
      zyre_h.zyre_stop (Self.Raw);
   end;
   ...
   function Zyre_Join (Self : in out Zyre_Node; Group : String)
     return Return_Status is
      use Interfaces.C.Strings;
      c_group : chars_ptr := New_String (Group);
   begin
      return Result : constant Return_Status :=
                         Return_Status (zyre_h.zyre_join (Self.Raw, c_group))
      do
         Free (c_group);
      end return;
   end;
   ...
   begin
      return Result : constant Return_Status :=
                         Return_Status (zyre_h.zyre_leave (Self.Raw, c_group))
      do
         Free (c_group);
      end return;
   end;
   ...
   function Zyre_Recv (Self : in out Zyre_Node) return Zmsgs.Zmsg is
   begin
      return Result : Zmsgs.Zmsg do
         Result.GetImplAcc.all := zyre_h.zyre_recv (Self.Raw);
      end return;
   end;
   ...
   function Zyre_Whisper
     ...
     return Return_Status is
      use Interfaces.C.Strings;
      c_peer : chars_ptr := New_String (Peer);
   begin
      return Result : constant Return_Status := Return_Status
        (zyre_h.zyre_whisper (Self.Raw, c_peer, Msg_P.GetImplAddr))
      do
         Free (c_peer);
      end return;
   end;
   ...
   begin
      return Result : constant Return_Status := Return_Status
        (zyre_h.zyre_shout (Self.Raw, c_group, Msg_P.GetImplAddr))
      do
         Free (c_group);
      end return;
   end;
   ...
   begin
      return Result : constant Return_Status := Return_Status
        (zyre_h.zyre_whispers (Self.Raw, c_peer, c_msg))
      do
         Free (c_peer);
         Free (c_msg);
      end return;
   ...
   begin
      return Result : constant Return_Status := Return_Status
        (zyre_h.zyre_shouts (Self.Raw, c_group, c_msg))
      do
         Free (c_group);
         Free (c_msg);
      end return;
   ...
   function Zyre_Peers (Self : Zyre_Node) return String_Zlists.Zlist is
   begin
      return raise NYI;
   end;
   ...
   function Zyre_Peers_By_Group
     (Self : Zyre_Node; Name : String) return String_Zlists.Zlist is
      use Interfaces.C.Strings;
      c_name : chars_ptr := New_String (Name);
   begin
      return Result : String_Zlists.Zlist do
         Result.GetImplAcc.all :=
           String_Zlists.Zmq_Zlist_T_Access
             (zyre_h.zyre_peers_by_group (Self.Raw, c_name));
         Free (c_name);
      end return;
   end;
   ...
   function Zyre_Own_Groups (Self : Zyre_Node) return String_Zlists.Zlist is
   begin
      return raise NYI;
   end;
   ...
   function Zyre_Peer_Groups (Self : Zyre_Node) return String_Zlists.Zlist is
   begin
      return raise NYI;
   end;
   ...
   function Zyre_Peer_Address
     (Self : Zyre_Node; Name : String) return String is
   begin
      return raise NYI;
   end;
   ...
   function Zyre_Peer_Header_Value
     (Self : Zyre_Node; Peer : String; Name : String) return String is
      use Interfaces.C.Strings;
      c_peer : chars_ptr := New_String (Peer);
      c_name : chars_ptr := New_String (Name);
   begin
      return Result : constant String :=
        Value (zyre_h.zyre_peer_header_value (Self.Raw, c_peer, c_name))
      do
         Free (c_peer);
         Free (c_name);
      end return;
   ...
   function Zyre_Socket (Self : Zyre_Node) return Zsocks.Zsock is
   begin
      return Result : Zsocks.Zsock do
         Result.GetImplAcc.all := zyre_h.zyre_socket (Self.Raw);
      end return;
   end;
   ...
   procedure Zyre_Print (Self : Zyre_Node) is
   begin
      raise NYI;
   end;
   ...
   --      zyre_version (void);
   function Zyre_Version return Interfaces.Unsigned_64 is
   begin
      return raise NYI;
   end;
   ...
   procedure Zyre_Test (Verbose : Boolean) is
   begin
      raise NYI;
   end;
