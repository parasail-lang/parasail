...
package body ZMQ.Zpollers is
   ...
   function Zpoller_New return Zpoller is
   begin
      return (Raw => zpoller_h.zpoller_new (System.Null_Address));
   end Zpoller_New;
   function Zpoller_New (Reader : Socket) return Zpoller is
   begin
      return (Raw => zpoller_h.zpoller_new (Reader, System.Null_Address));
   end Zpoller_New;
   function Zpoller_New (Reader, Reader2 : Socket) return Zpoller is
   begin
      return (Raw => zpoller_h.zpoller_new
        (Reader, Reader2, System.Null_Address));
   end Zpoller_New;
   function Zpoller_New (Reader, Reader2, Reader3 : Socket) return Zpoller is
   begin
      return (Raw => zpoller_h.zpoller_new
        (Reader, Reader2, Reader3, System.Null_Address));
   end Zpoller_New;
   function Zpoller_New (Reader, Reader2, Reader3, Reader4 : Socket)
     return Zpoller is
   begin
      return (Raw => zpoller_h.zpoller_new
        (Reader, Reader2, Reader3, Reader4, System.Null_Address));
   end Zpoller_New;

   --  Destroy a poller
   --  CZMQ_EXPORT void
   --  zpoller_destroy (zpoller_t **self_p);
   procedure Zpoller_Destroy (Self_P : in out Zpoller) is
   begin
      zpoller_h.zpoller_destroy (Self_P.Raw'Address);
   end;
   ...
   begin
      return Return_Status
        (zpoller_h.zpoller_add (Self.Raw, Reader));
   end;
   ...
   begin
      return Return_Status
        (zpoller_h.zpoller_remove (Self.Raw, Reader));
   end;
   ...
   procedure Zpoller_Set_Nonstop (Self : Zpoller; Nonstop : Boolean) is
   begin
      zpoller_h.zpoller_set_nonstop (Self.Raw,
        Interfaces.C.Extensions.bool (Nonstop));
   end;
   ...
   function Zpoller_Wait (Self : Zpoller; Timeout : Integer)
     return Socket is
   begin
      return zpoller_h.zpoller_wait (Self.Raw, Integer'Pos (Timeout));
   end;
   ...
   function Zpoller_Expired (Self : Zpoller) return Boolean is
   begin
      return Boolean (zpoller_h.zpoller_expired (Self.Raw));
   end;
   ...
   function Zpoller_Terminated (Self : Zpoller) return Boolean is
   begin
      return Boolean (zpoller_h.zpoller_terminated (Self.Raw));
   end;
